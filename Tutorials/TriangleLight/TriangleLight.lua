project "TutorialTriangleLight"
    kind "ConsoleApp"
    location "../TriangleLight"
    links {"RadeonRays", "CLW", "Calc"}
    files { "../TriangleLight/**.h", "../TriangleLight/**.cpp", "../Tools/shader_manager.h", "../Tools/shader_manager.cpp", "../TriangleLight/**.fsh", "../TriangleLight/**.vsh"}
